            ...
            {data && <div className={styles.infoFull} {...props}>
                <div className={styles.headInfo} onClick={(e) => setInfoOpen(false)}>
                    <div className={styles.nameBlock}>
                        <Image alt={data?.image.full ?? 'item'} width={50} height={50} src={process.env.NEXT_PUBLIC_DOMAIN + '/img/item/' + data?.image.full} />
                        <div>
                        ...
                        <div className={styles.into}>
                            {data.into.map((item) => (
                                <div className={styles.nameBlock} key={item} onClick={(e) => { setId(item) }}>
                                    <Image alt={item} width={50} height={50} src={process.env.NEXT_PUBLIC_DOMAIN + '/img/item/' + item + '.png'} />
                                    <div>
