        ...
        <div className={styles.spell} key={spell.id}>
            ...
            <div className={styles.shortInfo}>
                <div className={styles.imgBlock}>
                    <Image onClick={() => setButton(buttons[i])} className={styles.sellIcon} width={60} height={60} alt={spell.id} src={process.env.NEXT_PUBLIC_DOMAIN + '/img/spell/' + spell.image.full} />
        ...
        <div {...props} >
            <div >
                <div className={styles.spell}>
                    ...
                    <div className={styles.shortInfo}>
                        <Image className={styles.sellIcon} width={60} height={60} alt={passive.image.full} src={process.env.NEXT_PUBLIC_DOMAIN + '/img/passive/' + passive.image.full} />
