...
//баг - если видео не загрузилось, то прогрес бар дальше прибавляет секунды
const SpellVideo = ({ url, ...props }: SpellVideoProps) => {
    ...
    return (
        <div {...props}>
            <video onEnded={endVideo} onClick={(e: MouseEvent) => hideToolBar(e)} className={styles.video} ref={videoRef} style={{ width: '100%' }} src={url} />
