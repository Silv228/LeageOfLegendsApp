        ...
        <div className={styles.skins} {...props}>
            ...
            {isFullScreen &&
                <div className={styles.splashSkin}>
                    <Image alt={`splash_${champion}_` + (indexArray && indexArray[indexSkin])} width={1215} height={717} src={'http://ddragon.leagueoflegends.com/cdn/img/champion/splash/' + `${champion}_` + (indexArray && indexArray[indexSkin]) + '.jpg'} onClick={(e) => { setIsFullScreen(false) }} />
                </div>
            }
        </div>
    )
